...
* **Machine Learning & Graph:** `scikit-learn`, `scipy`, `networkx` — Available.
* **Plotting & Visualization:** `matplotlib` (installable via pip for figures).
* **API Policy:** All RL policy training, GNN link prediction, and LOO evaluations run **100% offline at $0.00 cost** using the cached Phase A ground truth.
